...
mxMondrianBase.prototype.cst = {
	MONDRIAN_BASE : 'mxgraph.mondrian.base',
...
//**********************************************************************************************************************************************************
mxMondrianBase.prototype.getSelectedColorSpecification = function(colorFamily) {
	switch(colorFamily) {
		case 'red':
...
mxMondrianBase.prototype.getLineColor = function(colorFamily) {
		return mxMondrianBase.prototype.getSelectedColorSpecification(colorFamily).swatch_60;
}

mxMondrianBase.prototype.getDividerLineColor = function(colorFamily, colorFillText) {
	if(colorFillText === 'swatch_10')
	{
		return mxMondrianBase.prototype.getSelectedColorSpecification(colorFamily).swatch_20;
	}
	else
	{
		return mxMondrianBase.prototype.getSelectedColorSpecification(colorFamily).swatch_10;
	}
}
...
mxCellRenderer.registerShape(mxMondrianBase.prototype.cst.MONDRIAN_BASE, mxMondrianBase);
 ...
 */
mxMondrianBase.prototype.cornerRadius = 8;
 ...
 */
mxMondrianBase.prototype.textSpacingLeft = 12;
 ...
 */
mxMondrianBase.prototype.textSpacingRight = 16;
 ...
 */
mxMondrianBase.prototype.iconSize = 24;
 ...
 */
mxMondrianBase.prototype.iconSpacing = 12;
 ...
 */
mxMondrianBase.prototype.titleBarHeight = 48;
...
mxMondrianBase.prototype.init = function(container)
{
	...
	this.shapeWidthIconView = mxMondrianBase.prototype.titleBarHeight;
	this.shapeHeightIconView = mxMondrianBase.prototype.titleBarHeight;
...
mxMondrianBase.prototype.paintVertexShape = function(c, x, y, w, h)
{
	...
	this.elementType = mxUtils.getValue(this.style, mxMondrianBase.prototype.cst.ELEMENT_TYPE, mxMondrianBase.prototype.cst.ELEMENT_TYPE_DEFAULT);
	this.shapeLayout = mxUtils.getValue(this.style, mxMondrianBase.prototype.cst.SHAPE_LAYOUT, mxMondrianBase.prototype.cst.SHAPE_LAYOUT_DEFAULT);
	...
	this.colorFillText = mxUtils.getValue(this.style, mxMondrianBase.prototype.cst.COLOR_FILL_TEXT, mxMondrianBase.prototype.cst.COLOR_FILL_TEXT_DEFAULT);
 ...
 */
mxMondrianBase.prototype.paintTitleBar = function(c, x, y, w, h)
{
 ...
 * Generic background painting implementation.
 */
mxMondrianBase.prototype.paintIconBox = function(c, x, y, w, h)
{
 ...
 * Generic background painting implementation.
 */
mxMondrianBase.prototype.paintShape = function(c, x, y, w, h)
{
	var shapeWidth = w;
	var shapeHeigth = h;
 ...
 * Generic background painting implementation.
 */
mxMondrianBase.prototype.paintIcon = function(c, x, y, w, h)
{
...
mxMondrianBase.prototype.getIconBoxWidth = function()
{
	if (this.image != null && (this.shapeLayout == 'icon' || this.shapeLayout == 'icon_name'))
	{	
...
mxMondrianBase.prototype.paintElementName = function(c, x, y, w, h)
{
