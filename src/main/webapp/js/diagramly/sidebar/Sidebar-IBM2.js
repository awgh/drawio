(function()
{
	...
	Sidebar.prototype.addIBM2BoxesPalette = function(d, dt, sb, s)
	{
		...
		// These will need to be more dynamic but for now are static from previous usage.
		...
		var fns = [
			 ...
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=cloud-ibm;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=3;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'IBM Cloud', 'IBM Cloud', true, null, this.getTagsForStencil(gn, 'ibm cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=cloud-region;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#919191;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Region', 'Region', true, null, this.getTagsForStencil(gn, 'region', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=cloud-zone;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=1;strokeColor=#919191;fillColor=#E0E0E0;' + deployedOnProperties,
					 200, 200, 'Zone', 'Zone', true, null, this.getTagsForStencil(gn, 'zone', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=cloud-public;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=3;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Public Network', 'Public Network', true, null, this.getTagsForStencil(gn, 'public network', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=cloud-enterprise;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=3;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Enterprise Network', 'Enterprise Network', true, null, this.getTagsForStencil(gn, 'enterprise network', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=cloud-classic;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Classic Infrastructure', 'Classic Infrastructure', true, null, this.getTagsForStencil(gn, 'classic infrastructure', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=cloud-services;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=1;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Cloud Services', 'Cloud Services', true, null, this.getTagsForStencil(gn, 'cloud services', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=cloud-accessgroup;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#C4982E;fillColor=none;' + deployedToProperties,
					 200, 200, 'Access Group', 'Access Group', true, null, this.getTagsForStencil(gn, 'access group', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=cloud-accountgroup;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#C4982E;fillColor=none;' + deployedToProperties,
					 200, 200, 'Account Group', 'Account Group', true, null, this.getTagsForStencil(gn, 'account group', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=cloud-resourcegroup;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#919191;fillColor=none;' + deployedToProperties,
			 ...
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=vpc-ibm;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'VPC', 'VPC', true, null, this.getTagsForStencil(gn, 'vpc virtual private cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=vpc-subnet;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=1;strokeColor=#00882B;fillColor=#E6F0E2;' + deployedOnProperties,
					 200, 200, 'Subnet:ACL', 'Subnet:ACL', true, null, this.getTagsForStencil(gn, 'subnet acl', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=vpc-virtualserver;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#00882B;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Virtual Server', 'Virtual Server', true, null, this.getTagsForStencil(gn, 'vsi virtual server instance', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=vpc-baremetal;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#00882B;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Bare Metal Server', 'Bare Metal Server', true, null, this.getTagsForStencil(gn, 'bare metal server', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=vpc-endpoints;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=3;strokeColor=#00882B;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Endpoints', 'Endpoints', true, null, this.getTagsForStencil(gn, 'endpoints', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=vpc-instancegroup;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#00882B;fillColor=none;' + deployedToProperties,
					 200, 200, 'Instance Group', 'Instance Group', true, null, this.getTagsForStencil(gn, 'instance group', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=vpc-securitygroup;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#FF0000;fillColor=none;' + deployedToProperties,
			 ...
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=kube-ibm;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'IBM Kubernetes Cluster', 'IBM Kubernetes Cluster', true, null, this.getTagsForStencil(gn, 'ibm kubernetes cluster', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=kube-general;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
			 ...
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=kube-openshift;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'OpenShift Cluster', 'OpenShift Cluster', true, null, this.getTagsForStencil(gn, 'openshift cluster', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=kube-service;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Kubernetes Service', 'Kubernetes Service', true, null, this.getTagsForStencil(gn, 'kubernetes service', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=kube-replicaset;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=#CDEBF9;' + deployedOnProperties,
					 200, 200, 'Kubernetes Replica Set', 'Kubernetes Replica Set', true, null, this.getTagsForStencil(gn, 'kubernetes replica set', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=kube-pod;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#B99ACD;fillColor=#F4E9F5;' + deployedOnProperties,
					 200, 200, 'Kubernetes Pod', 'Kubernetes Pod', true, null, this.getTagsForStencil(gn, 'kubernetes pod', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=kube-namespacegroup;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedToProperties,
			 ...
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=network-pop;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Point of Presence', 'Point of Presence', true, null, this.getTagsForStencil(gn, 'pop point presence', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=network-datacenter;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Data Center', 'Data Center', true, null, this.getTagsForStencil(gn, 'dc datacenter', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=network-overlay;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Overlay Network', 'Overlay Network', true, null, this.getTagsForStencil(gn, 'overlay network', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=network-vlan;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#00882B;fillColor=none;' + deployedOnProperties,
					 200, 200, 'VLAN', 'VLAN', true, null, this.getTagsForStencil(gn, 'vlan', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=network-server;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#4376BB;fillColor=none;' + deployedOnProperties,
					 200, 200, 'Server Content', 'Server Content', true, null, this.getTagsForStencil(gn, 'server', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=network-general;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#E0E0E0;fillColor=#E0E0E0;' + deployedOnProperties,
					 200, 200, 'General Content', 'General Content', true, null, this.getTagsForStencil(gn, 'general', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm2.box;boxType=network-other;boxKind=none;boxBar=0;boxLabel=0;rounded=0;strokeWidth=2;strokeColor=#DFF8FF;fillColor=#DFF8FF;' + deployedOnProperties,
