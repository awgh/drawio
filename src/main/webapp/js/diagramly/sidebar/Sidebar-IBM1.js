(function()
{
	Sidebar.prototype.addIBM1Palette = function()
	{
		...
		// Adds IBM shapes
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Analytics');
		this.addIBM1AnalyticsPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Applications');
		this.addIBM1ApplicationsPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Blockchain');
		this.addIBM1BlockchainPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Data');
		this.addIBM1DataPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1DevOps');
		this.addIBM1DevOpsPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Infrastructure');
		this.addIBM1InfrastructurePalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Management');
		this.addIBM1ManagementPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Miscellaneous');
		this.addIBM1MiscPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Security');
		this.addIBM1SecurityPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Social');
		this.addIBM1SocialPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Users');
		this.addIBM1UsersPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1VPC');
		this.addIBM1VPCPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Boxes');
		this.addIBM1BoxesPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary('ibm1', 'ibm1Connectors');
		this.addIBM1ConnectorsPalette(d, dt, sb, s);
		this.setCurrentSearchEntryLibrary();
	};

	Sidebar.prototype.addIBM1AnalyticsPalette = function(d, dt, sb, s)
	{
		s += 'analytics/';
		var gn = 'analytics ';
		...
		var fns = [
   		...
   		this.addPalette('ibm1Analytics', 'IBM 1.1 / Analytics', false, mxUtils.bind(this, function(content)
	    {
	...
	Sidebar.prototype.addIBM1ApplicationsPalette = function(d, dt, sb, s)
	{
		s += 'applications/';
		var gn = 'applications ';
		...
		var fns = [
   		...
   		this.addPalette('ibm1Applications', 'IBM 1.1 / Applications', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addIBM1BlockchainPalette = function(d, dt, sb, s)
	{
		s += 'blockchain/';
		var gn = 'blockchain';
		...
		var fns = [
   		...
   		this.addPalette('ibm1Blockchain', 'IBM 1.1 / Blockchain', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addIBM1DataPalette = function(d, dt, sb, s)
	{
		s += 'data/';
		var gn = 'data ';
	...
	Sidebar.prototype.addIBM1DevOpsPalette = function(d, dt, sb, s)
	{
		s += 'devops/';
		var gn = 'devops ';
	...
	Sidebar.prototype.addIBM1InfrastructurePalette = function(d, dt, sb, s)
	{
		s += 'infrastructure/';
		...
		var fns = [
   		...
   		this.addPalette('ibm1Infrastructure', 'IBM 1.1 / Infrastructure', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addIBM1ManagementPalette = function(d, dt, sb, s)
	{
		s += 'management/';
		var gn = 'management ';
		...
		var fns = [
   		...
   		this.addPalette('ibm1Management', 'IBM 1.1 / Management', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addIBM1MiscPalette = function(d, dt, sb, s)
	{
		s += 'miscellaneous/';
		...
		var fns = [
   		...
   		this.addPalette('ibm1Miscellaneous', 'IBM 1.1 / Miscellaneous', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addIBM1SecurityPalette = function(d, dt, sb, s)
	{
		s += 'security/';
		var gn = 'security ';
		...
		var fns = [
   		...
   		this.addPalette('ibm1Security', 'IBM 1.1 / Security', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addIBM1SocialPalette = function(d, dt, sb, s)
	{
		s += 'social/';
		var gn = 'social ';
		...
		var fns = [
   		...
   		this.addPalette('ibm1Social', 'IBM 1.1 / Social', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addIBM1UsersPalette = function(d, dt, sb, s)
	{
		s += 'users/';
		var gn = 'users ';
		...
		var fns = [
   		...
   		this.addPalette('ibm1Users', 'IBM 1.1 / Users', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
	...
	Sidebar.prototype.addIBM1VPCPalette = function(d, dt, sb, s)
	{
		s += 'vpc/';
	...
	Sidebar.prototype.addIBM1BoxesPalette = function(d, dt, sb, s)
	{
		s += 'boxes/';
		var gn = 'boxes box ';
		...
		var fns = [
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=cloud;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#4376BB;strokeWidth=3;dashed=0;container=1;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'IBM Cloud', 'IBM Cloud', true, null, this.getTagsForStencil(gn, 'ibm cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=vpc;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#4376BB;strokeWidth=2;dashed=0;container=1;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'VPC', 'VPC', true, null, this.getTagsForStencil(gn, 'vpc virtual private cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=region;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#919191;strokeWidth=2;dashed=0;container=1;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Region', 'Region', true, null, this.getTagsForStencil(gn, 'region', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=zone;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=#E0E0E0;rounded=0;whiteSpace=wrap;html=1;strokeColor=#919191;strokeWidth=1;dashed=0;container=1;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Zone', 'Zone', true, null, this.getTagsForStencil(gn, 'zone', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=subnet;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=#E6F0E2;rounded=0;whiteSpace=wrap;html=1;strokeColor=#00882B;strokeWidth=1;dashed=0;container=1;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Subnet:ACL', 'Subnet:ACL', true, null, this.getTagsForStencil(gn, 'subnet:acl', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=security;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#FF0000;strokeWidth=2;dashed=1;container=0;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Security Group', 'Security Group', true, null, this.getTagsForStencil(gn, 'ibm cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=instance;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#00882B;strokeWidth=2;dashed=1;container=0;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Instance Group', 'Instance Group', true, null, this.getTagsForStencil(gn, 'ibm cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=resource;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#919191;strokeWidth=2;dashed=1;container=0;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Resource Group', 'Resource Group', true, null, this.getTagsForStencil(gn, 'ibm cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=account;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#C4982E;strokeWidth=2;dashed=1;container=0;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Account Group', 'Account Group', true, null, this.getTagsForStencil(gn, 'ibm cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=namespace;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#4376BB;strokeWidth=2;dashed=1;container=0;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Namespace Group', 'Namespace Group', true, null, this.getTagsForStencil(gn, 'ibm cloud', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=public;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#4376BB;strokeWidth=3;dashed=0;container=1;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Public Network', 'Public Network', true, null, this.getTagsForStencil(gn, 'public network', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=enterprise;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#4376BB;strokeWidth=3;dashed=0;container=1;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Enterprise Network', 'Enterprise Network', true, null, this.getTagsForStencil(gn, 'enterprise network', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=classic;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#4376BB;strokeWidth=2;dashed=0;container=1;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Classic Infrastructure', 'Classic Infrastructure', true, null, this.getTagsForStencil(gn, 'classic infrastructure', dt).join(' ')),
			 this.createVertexTemplateEntry(
					 'shape=mxgraph.ibm1.box;prType=services;fontStyle=0;verticalAlign=top;align=left;spacingLeft=32;spacingTop=4;fillColor=none;rounded=0;whiteSpace=wrap;html=1;strokeColor=#4376BB;strokeWidth=1;dashed=0;container=1;spacing=-4;collapsible=0;expand=0;recursiveResize=0;',
					 200, 200, 'Cloud Services', 'Cloud Services', true, null, this.getTagsForStencil(gn, 'ibm cloud', dt).join(' '))
		];
	...
	Sidebar.prototype.addIBM1ConnectorsPalette = function(d, dt, sb, s)
	{
		var gn = 'connectors ';
		...
		var fns = [
   		...
   		this.addPalette('ibm1Connectors', 'IBM 1.1 / Connectors', false, mxUtils.bind(this, function(content)
	    {
			for (var i = 0; i < fns.length; i++)
			{
				content.appendChild(fns[i](content));
